...
class Program
{
    static void Main(string[] args)
    {
        ...
        // video1
        Video vid1 = new Video("Satisfying Therapeutic HORSESHOEING", "jk_horseshoeing", 799);
        ...
        vid2.Comment("KJK", "Thank you for sharing.");
        _videos.Add(vid2);
        ...
        vid3.Comment("HaileyS", "So cute! If I had a donkey, I'd name him Pickles!");
